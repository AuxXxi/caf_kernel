...
sed -i 's/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/down_differential\ 10/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/down_differential\ 3/g' /tmp/ramdisk/init.hammerhead.rc
sed -i 's/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/up_threshold_multi_core\ 70/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/up_threshold_multi_core\ 80/g' /tmp/ramdisk/init.hammerhead.rc
sed -i 's/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/optimal_freq\ 960000/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/optimal_freq\ 300000/g' /tmp/ramdisk/init.hammerhead.rc
sed -i 's/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/sync_freq\ 960000/write\ \/sys\/devices\/system\/cpu\/cpufreq\/ondemand\/sync_freq\ 300000/g' /tmp/ramdisk/init.hammerhead.rc
